/* Ported from https://mikeash.com/pyblog/fluid-simulation-for-dummies.html */
#include <math.h>
#include "control.c"
...
static FluidCube *cube;

void create(int size, int diffusion, int viscosity, float dt){
	cube = FluidCubeCreate(size, diffusion, viscosity, dt);
}

void addDensity(int x, int y, float amount){
	FluidCubeAddDensity(cube, x, y, amount);
}

void addVelocity(int x, int y, float amountX, float amountY){
	FluidCubeAddVelocity(cube, x, y, amountX, amountY);
}
